...
// Files is a handler for reading and writing to files
type Files struct {
	log   hclog.Logger
	store files.Storage
}
...
func NewFile(s files.Storage, l hclog.Logger) *Files {
...
func (f *Files) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	// here unless they have correct parameters

	f.saveFile(id, fn, rw, r)
}

func (f *Files) invalidURL(uri string, rw http.ResponseWriter) {
